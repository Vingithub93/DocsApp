...
public class MaxLifeInvalidCaseTest extends BaseTest {
	
	
public String testDesc = "Create a new invalid case of max life, diagnose the case and verify the diagnosed case";
	
	public String caseName="case 2";
	 ...
	 */
	@Test()
	public void createDiagnoseVerifyMaxLifeInvalidCase(){
